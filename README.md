...
│  Claude Code · Codex · Gemini CLI · Hermes · Kosmos · OpenCode   │
│  OpenClaw · Pi · VS Code Copilot · GitHub Copilot CLI            │
└───────────────┬──────────────────────────────────────────────────┘
...
- **10 种 AI 工具** — Claude Code、Codex、Gemini CLI、Hermes、Kosmos/PM Studio、OpenCode、OpenClaw、Pi、VS Code Copilot、GitHub Copilot CLI
...
- **通知钩子** — `pew init` 一键安装，AI 工具会话结束后自动触发同步（支持 8 种工具；Hermes、Kosmos 需手动安装插件）

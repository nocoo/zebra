...
interface TimelineInOutChartProps {
  data: HalfHourPoint[];
  className?: string;
}
...
/**
 * Timeline bar chart showing input/output tokens over 72 hours.
 */
export function TimelineInOutChart({
  data,
  className,
}: TimelineInOutChartProps) {
  if (!data.length) {
    return (
      <div
        className={cn(
